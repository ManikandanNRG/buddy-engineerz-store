      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {filteredAndSortedProducts.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <Link
              href="/products"
              className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-100 hover:text-gray-900 transition-all duration-300 transition-colors"
            >
              Browse All Products
            </Link>
          </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        ...
                        <button
                          ...
                          className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-100 hover:text-gray-900 transition-all duration-300 transition-colors font-medium"
                        >
                          Add to Cart
                        </button>
                      </div>
                ...
                <div key={product.id} className="bg-white rounded-lg shadow-sm overflow-hidden group hover:shadow-md transition-shadow">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-3">
                      ...
                      <button
                        onClick={() => handleAddToCart(product)}
                        className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-100 hover:text-gray-900 transition-all duration-300 transition-colors font-medium"
                      >
                        Add to Cart
                      </button>
                    </div>
