            ...
            <div className="border-t border-gray-700 mt-8 pt-8">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  {/* UPI */}
                  <div className="bg-white rounded-md px-2.5 py-1.5 flex items-center gap-1">
                    <span className="text-[11px] font-black text-purple-700">UPI</span>
                  </div>
                  {/* Visa */}
                  <div className="bg-white rounded-md px-2.5 py-1.5">
                    <span className="text-[11px] font-black text-blue-800 italic">VISA</span>
                  </div>
                  {/* Mastercard */}
                  <div className="bg-white rounded-md px-2 py-1.5 flex items-center gap-0.5">
                    <span className="w-4 h-4 rounded-full bg-red-500 inline-block opacity-90" />
                    <span className="w-4 h-4 rounded-full bg-yellow-400 inline-block -ml-1.5 opacity-90" />
                  </div>
                  {/* Razorpay */}
                  <div className="bg-white rounded-md px-2.5 py-1.5">
                    <span className="text-[11px] font-black text-blue-600">Razorpay</span>
                  </div>
                  {/* Net Banking */}
                  <div className="bg-white rounded-md px-2.5 py-1.5">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-400 items-center">
                  ...
                  <span>© 2026 Buddy Engineerz. All rights reserved.</span>
                </div>
              </div>
